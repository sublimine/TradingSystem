...
class VolatilityRegimeAdaptation(StrategyBase):
    ...
    def __init__(self, config: Dict):
        ...
        self.low_vol_entry_threshold = config.get('low_vol_entry_threshold', 1.5)
        self.high_vol_entry_threshold = config.get('high_vol_entry_threshold', 2.5)
        ...
        self.min_regime_confidence = config.get('min_regime_confidence', 0.7)
