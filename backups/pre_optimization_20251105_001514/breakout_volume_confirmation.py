...
class BreakoutVolumeConfirmation(StrategyBase):
    ...
    def __init__(self, config: Dict):
        ...
        self.atr_contraction_threshold = config.get('atr_contraction_threshold', 0.60)
        self.swing_point_order = config.get('swing_point_order', 5)
        self.volume_breakout_multiplier = config.get('volume_breakout_multiplier', 3.0)
        self.imbalance_confirmation_threshold = config.get('imbalance_confirmation_threshold', 0.35)
    ...
    def _confirm_microstructure(self, features: Dict, breakout: Dict) -> Dict:
        ...
        confirmation['is_confirmed'] = confirmation['imbalance_aligned'] and confirmation['vpin_appropriate']
